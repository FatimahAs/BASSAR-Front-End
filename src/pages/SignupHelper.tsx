...
export default function SignUpHelper() {
  ...
  const validateForm = () => {
    ...
    if (form.price <= 0) {
      Swal.fire('خطأ', 'السعر يجب أن يكون أكبر من 0', 'error');
      return false;
    }
  ...
  <div className="relative">
            ...
            <input
              ...
              type="text" onChange={e => setForm({ ...form, serviceType: e.target.value })}
              required
            />
          ...
          <div className="relative">
            ...
            <input
              ...
              type="number" onChange={e => setForm({ ...form, price: +e.target.value })}
              required
            />
          ...
          <div className="flex justify-center items-center">
            <p className="p-1 text-[#272343]">   سجل كمستخدم    </p>
